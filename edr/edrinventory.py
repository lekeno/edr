...
ODYSSEY_MATS = json.loads(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data', 'odyssey_mats.json')).read())

HORIZONS_MATS = json.loads(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data', 'horizons_mats.json')).read())
...
class EDRInventory(object):
    EDR_INVENTORY_ENCODED_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'encoded_mats.v1.p')
    EDR_INVENTORY_RAW_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'raw_mats.v1.p')
    EDR_INVENTORY_MANUFACTURED_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'manufactured_mats.v1.p')
    EDR_INVENTORY_COMPONENT_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'component_mats.v1.p')
    EDR_INVENTORY_ITEM_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'item_mats.v1.p')
    EDR_INVENTORY_CONSUMABLE_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'consumables.v1.p')
    EDR_INVENTORY_DATA_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'data_mats.v1.p')
    EDR_INVENTORY_BACKPACK_CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cache', 'backpack.v1.p')
