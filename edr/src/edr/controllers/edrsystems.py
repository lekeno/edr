...
class EDRSystems:
    ...
    EDSM_BODIES_CACHE = edr_cache_path('edsm_bodies.v2.p')
    EDSM_SYSTEMS_CACHE = edr_cache_path('edsm_systems.v4.p')
    EDSM_STATIONS_CACHE = edr_cache_path('edsm_stations.v2.p')
    EDSM_SYSTEMS_WITHIN_RADIUS_CACHE = edr_cache_path('edsm_systems_radius.v3.p')
    EDSM_TRAFFIC_CACHE = edr_cache_path('edsm_traffic.v2.p')
    EDSM_DEATHS_CACHE = edr_cache_path('edsm_deaths.v2.p')
    EDSM_MARKETS_CACHE = edr_cache_path('edsm_markets.v2.p')
    EDSM_SHIPYARDS_CACHE = edr_cache_path('edsm_shipyards.v2.p')
    EDSM_OUTFITTING_CACHE = edr_cache_path('edsm_outfitting.v2.p')
    EDSM_SYSTEM_VALUES_CACHE = edr_cache_path('edsm_system_values.v2.p')
