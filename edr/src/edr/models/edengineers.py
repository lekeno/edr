...
class EDEngineer:
    """
    Base class for an Elite Dangerous Engineer.
    """
    def __init__(self):
        """
    ...
    def update(self, progress):
        """
        Update the engineer's status from a progress event.

        Args:
            progress (dict): The progress dictionary from the Journal.
        """
    ...
    def dibs(self, materials):
        """
        Check if the engineer needs any of the provided materials for unlock/progress.

        Args:
            materials (dict): A dictionary of material counts.

        Returns:
            dict: A dictionary of materials claimed/needed (dibs).
        """
        return None

    def relevant(self, material_name):
        """
        Check if a material is relevant to this engineer.
    ...
    def interested_in(self, material_name):
        """
        Check if the engineer is currently interested in this material given their status.
...
class EDEngineerFactory:
    """
    Factory for creating Engineer instances.
    """
    __engineer_classes = {
    ...
    def from_engineer_progress_dict(progress):
        """
        Create and update an engineer from a progress dict.
        """
...
class EDEngineers:
    ...
    def __init__(self):
        self.engineers = {}
        # List of supported engineers
        engineers = [
            "domino green", "kit fowler", "yarden bond", "terra velasquez",
            "jude navarro", "hero ferrari", "wellington beck", "uma laszlo",
            "oden geiger", "baltanos", "rosa dayette", "eleanor bresa", "yi shen"
        ]
        for e in engineers:
    ...
    def update(self, engineer_progress_event):
        """
        Update engineers status from a progress event.
        """
    ...
    def dibs(self, materials):
        """
        Collect all dibs from all engineers.
        """
        dibs_list = []
    ...
    def is_useless(self, material_name):
        """
        Check if a material is useless (not used by any engineer or upgrade).
        """
    ...
    def is_contributing(self, material_name):
        """
        Check if a material contributes to any engineer unlock.
        """
        for name in self.engineers:
    ...
    def is_necessary(self, material_name):
        """
        Check if a material is currently necessary (interested by an engineer).
        """
        for name in self.engineers:
    ...
    def is_unnecessary(self, material_name):
        """
        Check if a material is unnecessary (relevant but not currently needed).
        """
        for name in self.engineers:
