...
class EDHullReinforcementPackage:
    """
    Base class for Hull Reinforcement Packages (HRPs).
    """
    ...
    def update_from(self, module):
        """
        Update HRP data from a module dictionary (engineering).

        Args:
            module (dict): The module data from Journal/Loadout.
        """
...
class EDGuardianHullReinforcementPackage:
    """
    Base class for Guardian Hull Reinforcement Packages.
    """

    def __init__(self):
        """
        Initialize the Guardian HRP.
        """
        self.armour = 0
...
class EDMetaAlloyHullReinforcementPackage:
    """
    Base class for Meta-Alloy Hull Reinforcement Packages.
    """

    def __init__(self):
        """
        Initialize the Meta-Alloy HRP.
        """
        self.armour = 0
...
class EDHullBulkhead:
    """
    Base class for Ship Hull (Bulkheads).
    """
    ...
    def update_from(self, module):
        """
        Update bulkhead data from a module dictionary.
    ...
    def strength(self, base_strength):
        """
        Calculate effective hull strength given a base strength.

        Args:
            base_strength (float): The ship's base hull strength.

        Returns:
            float: Modified hull strength.
        """
        if base_strength == 0:
            return 0
...
class EDHullFactory:
    """
    Factory for creating Hull/Armour objects from module names.
    """
    __module_classes = {
    ...
    def normalize_module_name(name):
        """
        Normalizes a module name to a canonical format key.

        Args:
            name (str): The raw module name.

        Returns:
            str: Normalized name key.
        """
    ...
    def from_internal_name(internal_name):
        """
        Create a hull object from an internal module name.

        Args:
            internal_name (str): The internal module name.

        Returns:
            EDHullBulkhead/EDHullReinforcementPackage: The hull object or None.
        """
    ...
    def default_armour():
        """
        Get the default armour (Lightweight Alloy).

        Returns:
            EDLightweightAlloyHull: The default hull.
        """
    ...
    def from_module(module):
        """
        Create and update a hull object from a module dictionary.

        Args:
            module (dict): The module dictionary.
