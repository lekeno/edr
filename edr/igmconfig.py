...
class IGMConfig(object):
    def __init__(self, config_file, user_config_file):
        ...
        user_cfg_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), user_config_file[0])
        if os.path.exists(user_cfg_path):
            ...
            user_cfg_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), user_config_file[1])
            if os.path.exists(user_cfg_path):
